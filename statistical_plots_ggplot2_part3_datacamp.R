...
```{r multiple_density_plots, fig.height=4, fig.width=4, fig.align='center'}
...
```{r multiple_density_plots_2, fig.height=4, fig.width=4, fig.align='center'}
...
```{r weighted_density_plots, fig.height=4, fig.width=4, fig.align='center'}
