...
```{r}
ggformular::gf_histogram( ~ fair) + stat_identity(aes(sum(fair == 14)), position = "identity")

# ggplot(as.data.frame(fair), aes(x = fair)) +
#   geom_histogram(binwidth = 0.05, boundary = 0.4, color = "white") + 
#   stat_identity(aes(sum(fair == 14)), position = "identity")
...
#   scale_x_continuous(limits=c(0, 50),breaks=c(0, 10, 20, 23, 30, 40, 50)) + theme_bw()   + opts(legend.position="none")
```
